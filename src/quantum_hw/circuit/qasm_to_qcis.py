"""QASM to QCIS converter.

Merged from vendor/cqlib qasm_to_qcis package. Original code licensed under
Apache 2.0 by China Telecom Quantum Group, QuantumCTek Co., Ltd.
"""
